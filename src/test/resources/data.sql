...
ALTER TABLE kata.product ALTER COLUMN id RESTART WITH 100;
ALTER TABLE kata.offer ALTER COLUMN id RESTART WITH 100;
ALTER TABLE kata.product_offer ALTER COLUMN id RESTART WITH 100;
ALTER TABLE kata.cart ALTER COLUMN id RESTART WITH 100;
ALTER TABLE kata.cart_item ALTER COLUMN id RESTART WITH 100;
ALTER TABLE kata.receipt ALTER COLUMN id RESTART WITH 100;
